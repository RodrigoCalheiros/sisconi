...
<%@ page contentType="text/html; charset=windows-1252" pageEncoding="windows-1252" language="java" import="java.sql.*, java.util.*, model.Estado"%>  
		...
		<form id="frm_paciente" action="paciente_cadastrar_processa.jsp" method="post">
			<table border="0" cellpadding="0" cellspacing="5">
				...
				<tr>
					...
					<td align="left"><input type="text" id="nr_cpf" name="nr_cpf" maxlength="14" size="50" placeholder="Insira o número do CPF do paciente" onKeyPress="MascaraCPF(form.nr_cpf);"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left"><input type="text" id="dt_nascimento" name="dt_nascimento" maxlength="10" size="50" placeholder="Insira a data de nascimento do paciente" onKeyPress="MascaraData(form.dt_nascimento);" required></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left"><input type="text" id="ds_cep" name="ds_cep" maxlength="8" size="50" placeholder="Insira o CEP do endereço do paciente"></td>
				</tr>
				<tr>
